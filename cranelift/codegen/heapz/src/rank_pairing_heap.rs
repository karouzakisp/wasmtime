...
impl<K: Hash + Eq + Clone, V: PartialOrd> RankPairingHeap<K, V> {
    fn new(heap_type: HeapType, passes: HeapPasses) -> Self {
        RankPairingHeap {
            root: None,
            heap_type,
            passes,
    ...
    pub fn single_pass_max() -> Self {
        Self::new(HeapType::Max, HeapPasses::Single)
    }
    ...
    pub fn single_pass_min() -> Self {
        Self::new(HeapType::Min, HeapPasses::Single)
    }
    ...
    pub fn multi_pass_max() -> Self {
        Self::new(HeapType::Max, HeapPasses::Multi)
    }
    ...
    pub fn multi_pass_min() -> Self {
        Self::new(HeapType::Min, HeapPasses::Multi)
    }
}
