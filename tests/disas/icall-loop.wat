...
;; @002b                               v5 = icmp.i32 uge v2, v4  ; v4 = 2
...
;; @002b                               v13 = band v12, v29  ; v29 = -2
;; @002b                               brif v12, block5(v13), block4
;;
;;                                 block4 cold:
;; @002b                               v15 = iconst.i32 0
;; @002b                               v17 = call fn0(v0, v15, v2)  ; v15 = 0
...
;; @0038                               v11 = load.i64 table_oob aligned table v8
;; @0038                               v12 = band v11, v27  ; v27 = -2
;; @0038                               brif v11, block5(v12), block4
;;
;;                                 block4 cold:
;; @0036                               v2 = iconst.i32 1
;; @0038                               v14 = iconst.i32 0
;; @0038                               v16 = call fn0(v0, v14, v2)  ; v14 = 0, v2 = 1
